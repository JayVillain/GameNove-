...
const storyChapter1 = [
    ...
    {
        type: "dialogue",
        background: "../../images/backgrounds/jalan.png", // <--- PERUBAHAN PATH GAMBAR
        character: "",
        name: "Narator",
    ...
    // Scene 1: Narasi - Zan Berhenti di Halte
    {
        type: "dialogue",
        background: "../../images/backgrounds/jalan.png", // <--- PERUBAHAN PATH GAMBAR
        character: "../../images/characters/zan.png", // <--- PERUBAHAN PATH GAMBAR
        name: "Narator",
    ...
    // Scene 2: Narasi - Zan Melihat Ramalia di Halte
    {
        type: "dialogue",
        background: "../../images/backgrounds/jalan.png", // <--- PERUBAHAN PATH GAMBAR
        character: "../../images/characters/ramalia.png", // <--- PERUBAHAN PATH GAMBAR
        name: "Narator",
    ...
    {
        type: "dialogue",
        background: "../../images/backgrounds/rumah.png", // <--- PERUBAHAN PATH GAMBAR
        character: "",
        name: "Narator",
...
function loadScene(sceneIndex) {
    ...
    if (sceneIndex === 500) { // Bad Ending Bab 1
        backgroundElement.src = "../../images/backgrounds/jalan.png"; // <--- PERUBAHAN PATH GAMBAR
    ...
    if (sceneIndex === 999) { // Transisi ke Bab 2 - Tampilkan tombol
        ...
        nextChapterButton.onclick = () => {
            // PATH NAVIGASI BERUBAH: Dari kumpul-bab, langsung ke bab2/bab2.html (karena kumpul-bab dan bab2 sejajar)
